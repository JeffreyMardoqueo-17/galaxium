    ...
    <DialogPrimitive.Root open={open} onOpenChange={onOpenChange}>
      ...
      <DialogPrimitive.Portal>
        ...
        <div className="fixed inset-0 flex items-center justify-center p-4">
          <DialogPrimitive.Content className="relative max-w-lg w-full rounded-md bg-white p-6 shadow-lg focus:outline-none">
            ...
            {createdMessage && (
              <p className="mb-4 text-sm text-green-600">{createdMessage}</p>
            )}
            ...
            {!showPhotoStep && isCreated && (
              <div className="space-y-4">
                <p className="text-sm text-gray-700">
                  ¿Deseas subir fotos del producto ahora?
                </p>
